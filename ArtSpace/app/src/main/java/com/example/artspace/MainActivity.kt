...
private fun ArtSpace() {
    ...
    when (artworkIndex) {
        0 -> {
            artwork = R.drawable.one
            artworkDescription = R.string.Couple
            artworkName = R.string.Couple
            artworkReleaseYear = R.string.CoupleNum
            author = R.string.author_Couple
        }
        1 -> {
            artwork = R.drawable.two
            artworkDescription = R.string.Adam
            artworkName = R.string.Adam
            artworkReleaseYear = R.string.AdamNum
            author = R.string.author_Adam
        }
        2 -> {
            artwork = R.drawable.three
            artworkDescription = R.string.Girl_with
            artworkName = R.string.Girl_with
            artworkReleaseYear = R.string.Girl
            author = R.string.author_Girl
        }
        else -> {
            artwork = R.drawable.four
            artworkDescription = R.string.Pompei
            artworkName = R.string.Pompei
            artworkReleaseYear = R.string.PompeiNum
            author = R.string.author_Pompei
        }
    }
